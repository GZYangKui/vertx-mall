...
public class CartRouter extends RouterVerticle {
    ...
    @RouterMapping(api = "/list", method = HttpMethod.GET, description = "获取购物车商品列表")
    ...
    @RouterMapping(api = "/computer", method = HttpMethod.POST, description = "计算购物车内商品价格")
    ...
    @RouterMapping(api = "/updateNum", method = HttpMethod.POST, description = "更新购物车商品数量")
    ...
    @RouterMapping(api = "/deletes", method = HttpMethod.POST, description = "删除购物车中的商品")
