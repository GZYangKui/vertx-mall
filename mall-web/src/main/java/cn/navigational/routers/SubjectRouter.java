...
public class SubjectRouter extends RouterVerticle {
    ...
    @RouterMapping(api = "/detail", description = "获取某一个专题详情", method = HttpMethod.GET)
    ...
    @RouterMapping(api = "/list", description = "获取商城专题列表", method = HttpMethod.GET)
    ...
    @RouterMapping(api = "/cateList", method = HttpMethod.GET, description = "获取专题分类")
